...
class SlicingPropertiesDialog extends ConsumerStatefulWidget {
  ...
  static Future<void> show(
    ...
    String tabId,
    TexturePackerNotifier notifier,
  ) {
    return showDialog(
      context: context,
  ...
  @override
  ConsumerState<SlicingPropertiesDialog> createState() =>
      _SlicingPropertiesDialogState();
}

class _SlicingPropertiesDialogState
    extends ConsumerState<SlicingPropertiesDialog> {
  ...
  void initState() {
    ...
    _tileWidthController = TextEditingController(
      text: config.tileWidth.toString(),
    );
    _tileHeightController = TextEditingController(
      text: config.tileHeight.toString(),
    );
