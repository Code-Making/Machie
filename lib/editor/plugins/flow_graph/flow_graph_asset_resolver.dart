...
final flowGraphAssetResolverProvider = Provider.family
    .autoDispose<AsyncValue<FlowGraphAssetResolver>, String>((ref, tabId) {
      ...
      return assetMapAsync.whenData((assetMap) {
        if (repo == null || project == null || metadata == null) {
          throw Exception(
            "Project context is not available for FlowGraphAssetResolver.",
          );
        }
