...
class FlowSchemaLoader implements AssetLoader<FlowSchemaAssetData> {
  ...
  @override
  Future<FlowSchemaAssetData> load(
    Ref ref,
...
class FlowGraphLoader
    implements
        AssetLoader<FlowGraphAssetData>,
        IDependentAssetLoader<FlowGraphAssetData> {
  @override
  bool canLoad(ProjectDocumentFile file) {
  ...
  Future<Set<String>> getDependencies(
    ...
    try {
      ...
      if (json['schema'] != null) {
        ...
        final dependencyUri = repo.resolveRelativePath(
          relativeFolder,
          json['schema'],
        );
  ...
  @override
  Future<FlowGraphAssetData> load(
    Ref ref,
    ProjectDocumentFile file,
    ProjectRepository repo,
  ) async {
    ...
    if (graph.schemaPath != null) {
      ...
      final schemaUri = repo.resolveRelativePath(
        relativeFolder,
        graph.schemaPath!,
      );
    ...
    return FlowGraphAssetData(graph: graph, schema: schemaData);
  }
}
